...
try:
    ...
    while (time.time() - start_time) < 60*10:
        ...
        # R_cube1 = quat_to_rotmat(quat_cube1)
        # R_cube2 = quat_to_rotmat(quat_cube2)

        R_cube1 = quat_to_rotmat(euler_to_quat(euler_cube1))
        R_cube2 = quat_to_rotmat(euler_to_quat(euler_cube2))
